...
library_books = Blueprint(
    "library_books", __name__, template_folder="templates"
)
...
def add_book():
    ...
    if request.method == "GET":
        ...
        return render_template("add_book.html", form=form, error=form.errors)
    else:
        form = BookForm()
        if form.validate_on_submit():
            tmp_authors = [
                [form.first_name.data, form.surname.data],
